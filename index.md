...
Use [`geom_4PL()`](http://www.myuhao.com/ggdose/reference/four-PL.md) in
ggplot. It will plot the dose response curve for you. The EC50 values
will be plotted in the upper right corner.
...
[`geom_4PL()`](http://www.myuhao.com/ggdose/reference/four-PL.md) ignore
all transformation made with the x axis, such as
...
[`geom_4PL()`](http://www.myuhao.com/ggdose/reference/four-PL.md) does
not plot individual data point that are used for the dose response
relation. Use it in conjunction with other geom to achieve the desired
look.
...
`y_offset` parameters in
[`geom_4PL()`](http://www.myuhao.com/ggdose/reference/four-PL.md)
